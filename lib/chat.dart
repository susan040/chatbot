...
class _ChatPageState extends State<ChatPage> {
  ...
  final api = "AIzaSyDW11yZsVMSlHzN1q3IgJS9GXjgtiNVh9A";

  @override
  Widget build(BuildContext context) {
// Define the getAnswer function to fetch bot response
    Future<void> getAnswer() async {
      final url =
          "https://generativelanguage.googleapis.com/v1beta2/models/chat-bison-001:generateMessage?key=$api";
